...
function createExecutionJournal(db, { secret, masterKey, claimOwnership = false, now = Date.now } = {}) {
	...
	return { begin, get, startCall, completeCall, checkpoint, finish, appendEvent, events, recover, receipts, reconcile, release };
}
