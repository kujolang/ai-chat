...
- Execute `web_search` through Ollama's authenticated Web Search API in a bounded provider tool loop; retain explicit `tool_execution_unavailable` errors for unsupported schemas.
